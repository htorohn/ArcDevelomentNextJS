...
const defaultQuestions = [
	{
		...
		options: [
			...
			},
			{
				...
				iconAlt: 'phones and tablet outlined',
				selected: false,
				cost: 0,
			},
			{
...
const Estimate = (props) => {
	...
	const getTotal = () => {
		...
		//quitamos el valor de la pregunta de la cantidad de usuarios ya qeu ese es un multiplicador
		//dado que si vamos a la parte de website development, no podemos tener mas de 2 preguntas
			...
			>
				...
				<Grid item xs={10}>
					<Typography variant='body1'>
						...
						{customFeatures.toLowerCase()} , and the project will be
						used by about {users} users.
					</Typography>
				</Grid>
			</Grid>
		</Grid>
		...
		<Grid container>
			<Head>
				...
				<meta
					name='description'
					key='description'
					content='Use our free online estimate calculator to instantly chack the cost of your custom software, 
				...
				<meta
					property='og:url'
					key='og:url'
					content='http://torosdevelopment.com/estimate'
				/>
				<link
					rel='canonical'
					key='canonical'
					href='http://torosdevelopment.com/estimate'
				/>
			</Head>
			{/* animation */}
			<Grid
