						...
						<Grid item container direction='column' md>
							...
							<Grid item>
								...
								>
									...
									purchasing, printing, and distribution of
									paper. On top of the massive environmental
									impact this has, it causes harm to your
									bottom line as well.
								</Typography>
								<Typography
									variant='body1'
								...
								>
									...
									accelerate your communication, and help the
									Earth.
								</Typography>
							</Grid>
						</Grid>
					...
					<Grid item container direction='column' alignItems='center'>
						...
						<Grid item className={classes.itemContainer}>
							...
							<Typography variant='body1' paragrap align='center'>
								We can help you thoroughly examine all areas of
								your business to develop a holistic plan for the
